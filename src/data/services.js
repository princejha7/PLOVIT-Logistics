export const services = [
  {
    ...
    fullDescription: `We offer a wide range of air freight solutions worldwide, partnering with multiple leading airlines, we provide competitive rates and ensure fast, secure delivery for all types of shipment packaging - including boxes, pallets, cartons, and more.
      <strong>Global Reach and Competitive Pricing:</strong> Extensive international air freight network, specializing in efficient shipments from Southeast Asia, Europe, and Middle East.
      <strong>Fast & Secure Delivery:</strong> Reliable, time-sensitive transportation with strict schedules and secure handling for all types of packaging.
      <strong>Streamlined Operations:</strong> Efficient documentation and seamless customs clearance ensure smooth, hassle-free shipments from origin to destination.
    `,
...

  {
    ...
    fullDescription: `Our ocean freight solutions are optimized for efficiency and reliability, ensuring your goods are transported by sea with care and precision. We work hard to keep shipments on schedule and costs under control. With careful cargo handling and clear communication, we make sure your deliveries arrive safely and on time.
      <strong>Timely Deliveries:</strong> Strict adherence to schedules with minimized delays from weather, port congestion, or customs.
      <strong>Cost-Effective Solutions:</strong> Competitive pricing through smart route planning, cargo consolidation (LCL/FCL), and optimized operations.
      <strong>Streamlined Documentation:</strong> Quick, accurate paperwork and compliance with international shipping regulations for smooth customs clearance.
    `,
