...
export const services = [
  {
    ...
    title: "Air Freight",
    shortDescription:
      "Fast and secure worldwide air freight solutions with competitive rates and streamlined customs clearance.",

    fullDescription: `
      We offer a wide range of air freight solutions worldwide, partnering with multiple leading airlines, we provide competitive rates and ensure fast, secure delivery for all types of shipment packaging - including boxes, pallets, cartons, and more.
...

  {
    ...
    fullDescription: `
      We offer export and import clearance for both air and ocean freight at major airports and seaports across India. Clients trust us for our strong commitment to compliance with local and international trade laws and expert advisory services that simplify customs processes to avoid unnecessary costs.
      ...
      <strong>Export Custom Clearance</strong>
...

  {
    ...
    fullDescription: `
      We offer reliable trucking and trailer freight services across a wide range of states, maintaining the highest quality standards. With a strong network of trusted partners and carriers, we ensure timely and secure deliveries for all types of cargo tailored to your business needs.
...

  {
    ...
    fullDescription: `
      We are equipped with efficient infrastructure and resources to handle all types of cargo across India. With specialized trailers and trucks, we provide reliable solutions for oversized and heavy cargo, prioritizing safety and timely delivery every step of the way.
...

  {
    ...
    fullDescription: `
      We provide integrated supply chain solutions, optimizing your entire logistics journey with efficient and sustainable operations. Operational excellence is at the heart of our approach. Our experts support every stage of your supply chain, applying industry best practices to ensure reliable service.
...

  {
    ...
    fullDescription: `
      Our consultancy services focus on compliance and certification in logistics, helping businesses navigate complex international trade regulations. We ensure your operations are efficient, lawful, and meet industry standards.
